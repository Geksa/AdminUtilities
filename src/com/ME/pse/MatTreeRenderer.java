...
public class MatTreeRenderer extends DefaultTreeCellRenderer
{
    /**
	 * 
	 */
    ...
    public MatTreeRenderer(final Icon icon)
    {
        customIcon = icon;
    }
        ...
        final boolean sel, final boolean expanded,  final boolean leaf, final int row, final boolean hasFocus)
    {
      ...
      if (value!=null)
      {
        ...
        final MatGroupData data = (MatGroupData) node.getUserObject();
        if (data!=null)
